...
- Sections: 137.
- Customer questions: 332.
- Evidence cards: 100.
- Unique English term IDs: 136.
- Unique English source IDs: 138.
...
The runtime registry imports all 21 modules and applies this policy. Import succeeded with 136 merged terms, 138 merged sources, and 332 questions. It fails by design for a missing owner, invalid owner, stale mapping, or invalid override shape.
