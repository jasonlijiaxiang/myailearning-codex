...
export const terminology = Object.freeze({
  ...
  token: term("词元", "Token", "模型处理文本时使用的离散单元；它可能是一个字、词的一部分、标点或特殊符号。", ["llm", "llm-inference"]),
  embedding: term("向量表示", "Embedding", "把文本、图片或其他对象映射为数值向量，使系统可以比较语义或特征距离。", ["llm", "rag", "data-engineering"]),
  transformer: term("Transformer 架构", "Transformer Architecture", "以注意力机制为核心并行处理序列，是现代大语言模型的主要基础架构。", ["llm", "llm-training"]),
  ...
  mcp: term("模型上下文协议", "Model Context Protocol", "让 AI 应用以统一方式发现并调用外部工具、资源和提示的开放协议。", ["mcp", "ai-agent"], "MCP"),
  ...
  observability: term("可观测性", "Observability", "通过指标、日志、Trace 和版本信息解释系统发生了什么以及为什么。", ["ai-ops", "evaluation", "ai-infra-platform"]),
  guardrails: term("护栏", "Guardrails", "在输入、上下文、输出和行动周围增加检测、约束或阻断；它不能替代身份与业务授权。", ["security", "ai-gateway"]),
  "identity-authorization": term("身份与授权", "Identity & Authorization", "确认真实主体，并根据资源、动作和上下文决定其是否有权访问或执行。", ["security", "mcp", "a2a"]),
  ...
  slo: term("服务等级目标", "Service Level Objective", "团队为某项服务指标设定的内部或协商目标，用于运营判断和错误预算管理。", ["ai-ops", "solution-patterns"], "SLO"),
  ...
  finops: term("云财务运营", "FinOps", "让工程、财务和业务共同理解并优化云资源的单位成本、预算和价值。", ["solution-patterns", "ai-ops", "ai-infra-platform"]),
});

export const glossaryGroups = Object.freeze([
  Object.freeze({ id: "model-core", zh: "模型基础与能力", en: "Model Foundations", termIds: Object.freeze(["model-landscape", "llm", "token", "embedding", "transformer", "attention", "qkv", "context-window", "kv-cache", "moe", "multimodal"]) }),
  ...
  Object.freeze({ id: "agents-protocols", zh: "智能体与协议", en: "Agents and Protocols", termIds: Object.freeze(["ai-agent", "perceive", "reason", "act", "observe", "planning", "memory", "tools", "tool-calling", "api", "mcp", "a2a", "tool-discovery", "agent-collaboration"]) }),
  ...
  Object.freeze({ id: "solution-delivery", zh: "方案与交付", en: "Solution and Delivery", termIds: Object.freeze(["solution-patterns", "ai-gateway", "model-routing", "poc", "sla", "slo", "tco", "finops"]) }),
]);
