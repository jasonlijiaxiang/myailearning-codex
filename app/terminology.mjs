...
export const terminology = Object.freeze({
  ...
  "ai-application-engineering": term("AI 应用工程", "AI Application Engineering", "把模型、Prompt、检索、工具、工作流、策略与评估作为一个可测试、可发布、可停止并可恢复的软件系统。", ["ai-ops"]),
  ...
  "ai-ops": term("AI 应用工程与运营", "AI Application Engineering & GenAIOps", "把跨组件制品、评估、发布、观测、成本和业务结果连接成可重放、可归因、可恢复的工程闭环。", ["ai-ops", "evaluation"]),
