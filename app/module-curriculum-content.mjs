...
export const moduleCurriculumContent = Object.freeze({
  ...
  "fine-tuning": {
    ...
    chapters: [
      ...
      { title: "DPO 与奖励训练使用不同反馈", en: "Preference & Reward", explanation: "DPO 用 chosen/rejected 偏好对改变相对倾向；基于奖励的训练适合答案能被规则、执行结果或可信评审验证的任务。二者的数据结构、训练器和评估方式不同。", decision: "好坏可比较用 DPO，结果可验证且收益明确时再考虑奖励训练。", boundary: "偏好会放大标注者价值判断，奖励也可能被模型钻空子。", sourceIds: ["dpo-2023", "hf-trl-dpo-trainer", "nist-genai-profile"] },
