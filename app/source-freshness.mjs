...
const reviewRules = Object.freeze([
  ...
  Object.freeze({ pattern: /产品文档|API 文档|技术文档|工程文档|SDK 文档|协议文档|官方协议规范|官方技术文章|模型行为规范|安全指南|安全工程文章|可观测规范|开放血缘规范|规范性文件|国家标准|法规实施页面|行业基金会框架|行业基金会指南|行业基金会工作组指南/, days: 90 }),
