export const agentDeepDives = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "补偿与审计", en: "Compensation & Audit", mechanism: "定义部分成功后的反向动作、人工恢复入口、版本和不可变审计凭证。", decision: "不可逆动作失败时，责任人能否看到完整工具调用记录并介入？", boundary: "补偿不是回滚时间，它本身也可能失败并需要审批。" },
    ],
  ...
  },
  {
    ...
    maxColumns: 2,
    items: [
      { name: "调用前崩溃", en: "Before Call", mechanism: "Checkpoint 中没有已执行动作记录，也没有外部 operation ID；恢复后可重新规划并执行。", decision: "恢复是否仍使用同一业务幂等键和最新权限？", boundary: "不能因为模型曾经提出调用就假设外部动作发生过。" },
...
const agentQaCandidates = [
  {
    ...
    ask: "模型需要动态决定哪些步骤？哪些步骤其实可以预先写死？任务何时算完成？",
    tag: "概念边界",
    basis: "官方定义 + 工程边界",
    evidence: [
  ...
  },
  {
    ...
    ask: "任务入口有哪些，哪套系统提供 ground truth？执行后用哪个业务状态证明成功？",
    tag: "动作循环",
  ...
  },
  {
    ...
    ask: "审计真正需要解释哪项业务决策？现有日志能否关联计划、工具、授权、结果与停止原因？",
    tag: "可解释与审计",
  ...
  },
  {
    ...
    ask: "任务路径为什么不可写死？最长有多少步，哪些里程碑必须审批，环境变化后如何重规划？",
    tag: "规划机制",
    basis: "官方架构模式",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪几个决策无法用规则表达？允许模型试错几次？哪些动作必须确定性执行？",
    tag: "路线选择",
    basis: "官方模式指南",
    evidence: [
  ...
  },
  {
    ...
    ask: "系统只提供信息，还是要跨系统执行动作？需要依据哪些知识？最终由谁确认？",
    tag: "方案边界",
    basis: "官方定义 + 组合架构",
    evidence: [
  ...
  },
  {
    ...
    ask: "每个工具解决什么唯一问题？哪些工具可写、可逆或涉及资金与敏感数据？",
    tag: "工具治理",
    basis: "官方工程指南",
    evidence: [
  ...
  },
  {
    ...
    ask: "要记住什么、为谁记、保存多久、谁能纠正或删除？记忆是否会影响后续业务动作？",
    tag: "记忆治理",
    basis: "官方产品能力 + 风险管理",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪些动作不可逆？使用用户授权还是服务账号？谁审批，执行后由哪个权威系统证明动作真正完成？",
    tag: "安全",
    basis: "零信任原则 + 云平台控制",
    evidence: [
  ...
  },
  {
    ...
    ask: "拆分要解决哪个已观察失败？哪些子任务没有前后依赖，每个 Agent 的输入、权限、预算和终止条件是什么？",
    tag: "架构选择",
    basis: "官方编排指南",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪个系统状态证明完成？哪些中间步骤即使结果正确也不能出错，哪类风险必须为零？",
    tag: "评估",
    basis: "基准论文 + 风险框架",
    evidence: [
  ...
  },
  {
    ...
    ask: "当前用什么 APM / 日志平台？需要保留哪些轨迹、多久、谁能查看？",
    tag: "可观测",
    basis: "可观测标准 + 云平台能力",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪些能力必须托管或可移植？数据、地域、身份、网络和现有可观测平台有哪些硬约束？",
    tag: "云选型",
    basis: "三家云官方文档",
    evidence: [
  ...
  },
  {
    ...
    ask: "P95、任务完成时限、并发和失败重试预算是什么？哪些步骤可以异步或由工作流执行？",
    tag: "FinOps",
    basis: "官方工程指南 + PoC 测量",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪些任务允许建议或自动执行？哪类错误必须为零，谁签署门槛，失败后怎样停止、补偿和接管？",
    tag: "上线治理",
    basis: "官方护栏建议 + 风险框架",
    evidence: [
  ...
  },
  {
    ...
    ask: "能力由谁拥有和部署？需要共享工具，还是委托完整任务？信任边界跨越哪些团队、租户和身份？",
    tag: "协议边界",
    basis: "官方协议架构与职责边界",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪些信息允许模型总结后保存，哪些必须每次回到 CRM、ERP 或策略系统读取？谁能纠正和删除？",
    tag: "记忆治理",
    basis: "云平台记忆实现 + 风险治理",
    evidence: [
  ...
  },
  {
    ...
    ask: "目标系统为何没有 API？动作是否可逆？能否提供隔离账号、沙箱环境、回放证据和人工审批？",
    tag: "执行方式",
  ...
  },
  {
    ...
    ask: "哪个系统是 ground truth？哪些事件触发状态转换，成功需要哪些可机器验证的后置条件？",
    tag: "Run 状态机",
    basis: "官方运行循环 + 持久任务语义",
    evidence: [
  ...
  },
  {
    ...
    ask: "API 超时后怎样确认是否已执行？重复调用、部分成功和审批参数变化分别怎样处理？",
    tag: "工具契约",
    basis: "开放标准 + 工具职责边界",
    evidence: [
  ...
  },
  {
    ...
    depth: "Checkpoint 要记录 Run 状态、工具调用记录、审批信息，以及模型、Prompt 和工具版本。恢复前先判断崩溃发生在调用前、调用中还是副作用后，并重新校验权限与资源版本。跨系统很难轻率承诺 exactly-once，应具备去重、检测、补偿和人工恢复的能力。",
    ask: "现有 API 是否支持幂等键或查询 operation 状态？工具调用记录和人工恢复入口在哪里？",
    tag: "故障恢复",
    basis: "持久编排 + 人工恢复机制",
    evidence: [
  ...
  },
  {
    ...
    ask: "动作代表用户还是后台服务？令牌由谁签发、scope 到什么粒度、等待期间权限变化如何重新验证？",
    tag: "身份授权",
  ...
  },
  {
    ...
    ask: "哪些事件会让原计划失效？重规划允许改变哪些步骤？审批、预算和截止时间是否需要重新确认？",
    tag: "规划机制",
  ...
  },
  {
    ...
    ask: "现有 API 在身份、前置条件、副作用、幂等、错误、后置验证和补偿上分别声明了什么？",
    tag: "工具契约",
    basis: "开放接口标准 + 工具执行职责",
    evidence: [
  ...
  },
  {
    ...
    ask: "除了字段类型，执行前还要校验哪些租户、权限、额度、资源版本和政策条件？",
    tag: "工具契约",
  ...
  },
  {
    ...
    ask: "审批需要展示哪些业务字段？授权绑定多久？参数、政策或资源变化后由谁触发重新审批？",
    tag: "人工介入",
  ...
  },
  {
    ...
    ask: "超时或崩溃后怎样查询真实状态？哪些操作支持幂等，哪些部分成功需要补偿，补偿失败由谁接手？",
    tag: "故障恢复",
    basis: "持久编排语义 + 接口边界",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪些事件触发每次状态转换？取消、超时和人工接管怎样表示？修复任务如何关联原 Run？",
    tag: "Run 状态机",
  ...
  },
  {
    ...
    a: "应保存足以确定性恢复 Run 的状态与工具调用记录，并至少在外部副作用前后、进入等待前和关键里程碑后建立检查点。",
    ...
    ask: "崩溃发生在调用前、调用中和调用后时，现有记录分别能证明什么？敏感凭证怎样安全恢复？",
    tag: "故障恢复",
  ...
  },
  {
    ...
    ask: "最长等待多久？唤醒事件来自哪里？超时、重复事件和恢复时重新授权分别怎么处理？",
    tag: "长任务运行",
    basis: "持久外部事件 + 人工交互模式",
    evidence: [
  ...
  },
  {
    ...
    ask: "记忆的事实源在哪里？谁能纠正或删除？删除需要传播到哪些派生存储，怎样验证已经生效？",
    tag: "记忆治理",
  ...
  },
  {
    ...
    ask: "子 Agent 的输出由谁验收？最多允许几层委托和多少并发，谁拥有最终权限、预算和终止权？",
    tag: "多 Agent",
  ...
  },
  {
    ...
    ask: "能力拥有者是否独立部署？需要共享工具，还是委托完整任务？跨越了哪些团队、租户和身份边界？",
    tag: "协议边界",
  ...
  },
  {
    ...
    ask: "最多允许几层委托和多少并发？谁拥有最终任务预算？发现循环或冲突时由谁终止？",
    tag: "多 Agent",
  ...
  },
  {
    ...
    ask: "哪些中间步骤必须正确，即使最终结果看似成功？现有 Trace 能否关联权限、工具、观察和业务终态？",
    tag: "轨迹评估",
  ...
  },
  {
    ...
    ask: "哪些能力必须托管，哪些必须可移植？目标地域、网络、身份和现有可观测平台有哪些硬约束？",
    tag: "云选型",
    basis: "三家云官方平台能力",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪些子任务没有前后依赖？拆分后减少了什么上下文或权限？成功任务成本和 P95 基线是多少？",
    tag: "FinOps",
    basis: "Agent 编排与成本边界",
    evidence: [
  ...
  },
  {
    ...
    ask: "哪类错误必须为零？谁签署高风险任务门槛？上线后达到什么条件会自动降级、停止或回滚？",
    tag: "生产验收",
  ...
  },
  {
    ...
    depth: "Harness 是让模型安全完成任务的运行层：它装配上下文，提供并调用工具，保存 Run 状态，执行权限与预算，并处理重试、审批、沙箱、观测和结果验证。Framework 可以提供部分代码结构，MCP 可以标准化工具、资源和 Prompt 的连接，但都不会自动补齐业务授权、恢复与验收。一个产品常同时拥有 Framework、协议适配器和自己的 Harness；比较时要看各自承担什么责任，而不是只看名称。",
    ask: "当前系统由谁装配上下文、执行工具、保存状态、验证终态并在失败后恢复？哪些能力只是框架 API 或协议连接？",
    tag: "Harness 边界",
  ...
  },
  {
    ...
    ask: "比较时能否固定模型、任务、预算和环境？差异来自上下文、工具、验证、权限、恢复还是产品交互？",
    tag: "Harness 评估",
