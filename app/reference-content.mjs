...
export const sourceLedger = {
  ...
  "attention-not-explanation-2019": {
    grade: "A", kind: "同行评审论文", shortTitle: "Attention Is Not Explanation",
  ...
  "deduplicating-training-data-2022": {
    grade: "A", kind: "同行评审论文", shortTitle: "Deduplicating Training Data",
  ...
  "pytorch-distributed-checkpoint": {
    grade: "O", kind: "官方技术文档", shortTitle: "PyTorch Distributed Checkpoint",
  ...
  "pytorch-reproducibility": {
    grade: "O", kind: "官方技术文档", shortTitle: "PyTorch Reproducibility",
  ...
  "hf-transformers-tokenizer-contract": {
    grade: "O", kind: "官方工程文档", shortTitle: "Transformers Tokenizer Contract",
  ...
  "longvideobench-2024": {
    grade: "A", kind: "同行评审论文", shortTitle: "LongVideoBench",
  ...
  "mcp-mrtr-2026-07-28": {
    grade: "O", kind: "官方协议规范", shortTitle: "MCP Multi Round-Trip Requests",
  ...
  "mcp-list-cache-2026-07-28": {
    grade: "O", kind: "官方协议规范", shortTitle: "MCP Result Caching",
  ...
  "mcp-http-routing-2026-07-28": {
    grade: "O", kind: "官方协议规范", shortTitle: "MCP HTTP Routing Metadata",
  ...
  "a2a-release-1-0-1": {
    grade: "O", kind: "官方协议文档", shortTitle: "A2A v1.0.1 Release",
  ...
  "a2a-agent-discovery": {
    grade: "O", kind: "官方协议文档", shortTitle: "A2A Agent Discovery",
  ...
  "a2a-extensions": {
    grade: "O", kind: "官方协议文档", shortTitle: "A2A Extensions",
  ...
  "a2a-mcp-boundary": {
    grade: "O", kind: "官方协议文档", shortTitle: "A2A and MCP",
  ...
  "cloudflare-ai-gateway-authentication": {
    grade: "P", kind: "官方产品文档", shortTitle: "AI Gateway Authentication",
  ...
  "cloudflare-ai-gateway-caching": {
    grade: "P", kind: "官方产品文档", shortTitle: "AI Gateway Caching",
  ...
  "cloudflare-ai-gateway-spend-limits": {
    grade: "P", kind: "官方产品文档", shortTitle: "AI Gateway Spend Limits",
  ...
  "cloudflare-ai-gateway-dynamic-routing": {
    grade: "P", kind: "官方产品文档", shortTitle: "AI Gateway Dynamic Routing",
  ...
  "azure-apim-ai-gateway": {
    grade: "P", kind: "官方产品文档", shortTitle: "Azure APIM AI Gateway",
  ...
  "aws-builders-library-retries": {
    grade: "P", kind: "官方工程指南", shortTitle: "Timeouts, Retries & Jitter",
  ...
  "openai-hugging-face-incident-technical-report-2026": {
    grade: "B", kind: "厂商技术报告", shortTitle: "OpenAI–Hugging Face Agent Incident",
  ...
  "metr-openai-hf-incident-2026": {
    grade: "A", kind: "独立技术报告", shortTitle: "METR 独立事件调查",
  ...
  "ncsc-agentic-ai-risk-interim-2026": {
    grade: "O", kind: "政府临时安全指南", shortTitle: "NCSC Agentic AI Risk",
  ...
  "terminal-bench-v21": {
    grade: "A", kind: "任务特定研究", shortTitle: "Terminal-Bench v2.1",
  ...
  "scicode-verified-2026": {
    grade: "B", kind: "论文 · 任务特定研究", shortTitle: "SciCode-Verified",
  ...
  "coding-index": {
    grade: "A", kind: "项目组合指数 · 任务特定研究", shortTitle: "Coding Composite",
  ...
  "agentic-index": {
    grade: "A", kind: "项目组合指数 · 任务特定研究", shortTitle: "Agentic Composite",
  ...
  "product-tongyi-lingma": {
    grade: "P", kind: "官方产品文档", shortTitle: "通义灵码历史入口",
    title: "通义灵码 — 历史下载入口",
  ...
  "product-qoder-cn-series": {
    grade: "P", kind: "官方产品文档", shortTitle: "Qoder CN 产品系列",
  ...
  "product-qoder-cn-ide": {
    grade: "P", kind: "官方产品文档", shortTitle: "Qoder CN IDE",
