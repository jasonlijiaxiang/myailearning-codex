...
export const sourceLedger = {
  ...
  "mcp-2026-07-28-rc": {
    ...
    note: "历史 RC 公告记录了计划发布日期与候选变更；截至 2026-07-29，该里程碑已由 2026-07-28 正式规范完成，规范性要求必须回到正式版，不能继续把 RC 当作当前状态。",
    verifiedAt: "2026-07-29", href: "https://blog.modelcontextprotocol.io/posts/2026-07-28-release-candidate/",
  },
  ...
  "a2a-specification": {
    ...
    note: "A2A 最新规范入口，覆盖 Message 或 Task 响应、精确任务状态、逐请求 Major.Minor 版本、协议绑定、取消与更新；具体 SDK、云服务和 Agent 产品支持仍需逐项核验。",
    verifiedAt: "2026-08-01", href: "https://a2a-protocol.org/latest/specification/",
  },
  "a2a-release-1-0-1": {
    ...
    verifiedAt: "2026-08-01", href: "https://github.com/a2aproject/A2A/releases/tag/v1.0.1",
  },
  "a2a-mcp-boundary": {
