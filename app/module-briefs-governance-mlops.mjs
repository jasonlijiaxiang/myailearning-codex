...
export const aiGovernanceBrief = {
  ...
  deepDives: [
    { kind: "sequence", eyebrow: "RECRUITMENT GOVERNANCE CHAIN", title: "从写作助手到候选人排序的八段决策链", intro: "每一步都产生下一项决定需要的证据，也定义什么情况下必须退回上一步。", sourceIds: ["nist-ai-rmf", "iso-iec-42001", "iso-iec-42005", "eu-ai-act"], items: [
    ...
    { kind: "matrix", eyebrow: "EVIDENCE BOUNDARIES", title: "四类依据回答不同问题", intro: "可以交叉映射，但不能把不同证据压成一个“已合规”状态。", sourceIds: ["nist-ai-rmf", "iso-iec-42001", "iso-iec-42005", "eu-ai-act", "eu-ai-act-2026-1744"], items: [
  ...
  qa: [
    { q: "AI 治理和 AI 安全是不是同一件事？", a: "不是。Security 负责攻击、泄漏、越权和技术控制；Governance 定义具体用途的批准门禁、证据、例外与复审机制，获授权的业务责任人作出运行决定并接受权限范围内的残余风险。", depth: "招聘案例中，Security 要证明恶意简历不能扩大权限或直接改变 ATS；Governance 要规定筛选用途需要哪些证据、人工监督和申诉机制，以及由谁批准。两者共享证据但不能互相代替。", ask: "追问客户：当前缺口是技术控制失效，还是缺少有权批准、限制和停止这个用途的人与机制？", tag: "职责边界", basis: "风险框架 + 管理体系", evidence: [evidence("nist-ai-rmf", "框架面向个人、组织与社会风险，不限于网络安全。"), evidence("iso-iec-42001", "标准面向组织级 AI 管理体系的建立与持续改进。")] },
    { q: "NIST AI RMF、ISO/IEC 42001 和法规分别能证明什么？", a: "AI RMF 提供自愿风险方法，ISO/IEC 42001 规定组织管理体系要求，法规规定特定司法辖区的法定义务；三者都不能单独证明某个招聘系统安全、公平或已经合规。", depth: "可以把不同依据映射到内部控制，但必须保留来源范围和证据性质。AI RMF 1.0 仍在修订，管理体系证据不等于产品技术保证，具体法律适用性由合格专业人员判断。", ask: "追问客户：当前需要的是内部风险方法、体系审核证据，还是某项具体法律结论？", tag: "框架边界", basis: "NIST 与 ISO 官方说明", evidence: [evidence("nist-ai-rmf", "说明 AI RMF 自愿采用、用于风险管理，且 1.0 正在修订。"), evidence("iso-iec-42001", "明确对象是组织的 AI management system，而非单个模型或应用认证。")] },
    { q: "AI 清单至少应该登记什么？", a: "用途、所有者、用户、受影响对象、业务决定、模型与版本、数据、自动化程度、地区、供应商、生产状态和风险层级。", depth: "同一模型的职位描述写作与候选人排序要分别登记，再连接到 ATS、评估、安全控制和批准记录。只扫描 API 调用无法发现真实用途、影子 AI 或谁被决定影响。", ask: "追问客户：供应商变化或候选人申诉时，多久能列出受影响用途、版本和责任人？", tag: "系统清单", basis: "治理可追溯性", evidence: [evidence("iso-iec-42001", "支持通过组织政策、目标和过程管理 AI 系统。"), evidence("nist-ai-rmf", "支持把风险管理纳入 AI 的设计、开发、使用和评估。")] },
    { q: "如何给招聘 AI 做风险分级？", a: "按具体用途和影响分级，不按模型名称。写作辅助与候选人筛选、评分、排序不能共用同一层级。", depth: "候选人排序会影响个人机会，应在组织内进入高影响层级并增加影响评估、独立验证、人工监督、申诉、事件和更高批准。欧盟委员会把就业和简历筛选列为高风险用途示例，但案例系统的具体法律分类仍需结合 intended purpose、角色和完整法源判断。", ask: "追问客户：系统只是整理信息，还是会建议、排序、淘汰或实质影响进入下一轮？", tag: "风险分级", basis: "情境风险 + 有边界的法规线索", evidence: [evidence("nist-ai-rmf", "强调将风险管理纳入具体 AI 产品、服务和系统的生命周期。"), evidence("eu-ai-act", "官方页面把就业与候选人筛选列为高风险用途示例；不替代具体法律分类。")] },
    { q: "使用第三方招聘模型后，治理责任是否转给供应商？", a: "不会。供应商负责承诺范围，采用方仍对具体用途、数据、配置、集成、人工流程和最终决定负责。", depth: "采购要验证版本、地域、数据处理、评估、事件通知、分包商、停服与退出；上线后监控供应商变化是否使原批准失效。认证和合同材料只能证明其明确范围，不能覆盖客户自己的 ATS 集成与决策流程。", ask: "追问客户：合同是否承诺版本变更、数据边界、事件协作和可退出性？", tag: "第三方治理", basis: "共享责任 + 持续治理", evidence: [evidence("iso-iec-42001", "标准同时适用于提供或使用 AI 产品与服务的组织。"), evidence("nist-ai-rmf", "风险框架覆盖 AI 产品、服务和系统的开发与使用。")] },
    { q: "欧盟 AI Act 的时间表可以一次写死吗？", a: "不可以。2026 年正式修法已改变部分高风险规则的适用时点，动态页面和 Claims 台账都要事件驱动更新。", depth: "截至 2026-07-30，总体适用节点仍为 2026-08-02；Regulation (EU) 2026/1744 已于 2026-07-27 生效。Chapter III Sections 1–3（Article 6(5) 除外）对按 Article 6(2)/Annex III 分类的系统自 2027-12-02 适用，对按 Article 6(1)/Annex I 分类的系统自 2028-08-02 适用；不能把它简化为这些系统的全部义务都延期。具体角色、分类和义务由法务确认。", ask: "追问客户：组织扮演什么角色，招聘用途落在哪项正式分类，谁负责跟踪后续法源变化？", tag: "法规时效", basis: "委员会实施页面 + 正式修法", evidence: [evidence("eu-ai-act", "提供当前实施入口与招聘用途示例。"), evidence("eu-ai-act-2026-1744", "正式修订文本限定了适用章节、Article 6(5) 例外、分类与 2027/2028 时点。")] },
    { q: "怎样避免招聘 AI 治理变成只填表？", a: "让每项声明连接到可测试控制和运行证据，并让投诉、事件或重大变化触发重新决定。", depth: "证据包要连接用途、候选人群、数据与模型版本、切片评估、安全测试、人工监督、审批、例外、申诉、事件和退役证明。抽样验证文档与生产实际一致，而不是只检查字段是否填写。", ask: "追问客户：哪三项关键控制能从政策一路追到当前 ATS 工作流和实际运行结果？", tag: "治理落地", basis: "持续保证", evidence: [evidence("iso-iec-42001", "要求建立、实施、维护并持续改进管理体系。"), evidence("nist-ai-rmf", "将风险管理贯穿设计、开发、使用与评估。")] },
  ].map((item) => ({ ...item, addedAt: "2026-07-21" })),
  evidenceCards: [
...
export const governanceMlopsCurriculum = {
  ...
  "ai-governance": {
    ...
    chapters: [
      ...
      { title: "组织风险分层与法律分类", en: "Tiering & Classification", explanation: "组织层级按影响、自动化、可逆性、规模和敏感数据配置门禁；法律分类还要结合 intended purpose、角色、地区与完整法源。", decision: "先把候选人排序纳入高影响组织层级，再由专业人员确认法律分类。", boundary: "内部 tier 不是法律结论，招聘用途示例也不等于所有面试助手都自动高风险。", sourceIds: ["nist-ai-rmf", "eu-ai-act"] },
