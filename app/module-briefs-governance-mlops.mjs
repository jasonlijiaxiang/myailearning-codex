...
export const aiGovernanceBrief = {
  ...
  deepDives: [
    { kind: "sequence", eyebrow: "RECRUITMENT GOVERNANCE CHAIN", title: "招聘 AI 的治理决策步骤", intro: "每一步都产生下一项决定需要的证据，也定义什么情况下必须退回上一步。", sourceIds: ["nist-ai-rmf", "iso-iec-42001", "iso-iec-42005", "eu-ai-act"], items: [
  ...
  qa: [
    ...
    { q: "欧盟 AI Act 的时间表可以一次写死吗？", a: "不可以。2026 年正式修法已改变部分高风险规则的适用时点，动态页面和 相关事实记录都要事件驱动更新。", depth: "截至 2026-07-30，总体适用节点仍为 2026-08-02；Regulation (EU) 2026/1744 已于 2026-07-27 生效。Chapter III Sections 1–3（Article 6(5) 除外）对按 Article 6(2)/Annex III 分类的系统自 2027-12-02 适用，对按 Article 6(1)/Annex I 分类的系统自 2028-08-02 适用；不能把它简化为这些系统的全部义务都延期。具体角色、分类和义务由法务确认。", ask: "组织扮演什么角色，招聘用途落在哪项正式分类，谁负责跟踪后续法源变化？", tag: "法规时效", basis: "委员会实施页面 + 正式修法", evidence: [evidence("eu-ai-act", "提供当前实施入口与招聘用途示例。"), evidence("eu-ai-act-2026-1744", "正式修订文本限定了适用章节、Article 6(5) 例外、分类与 2027/2028 时点。")] },
    { q: "怎样避免招聘 AI 治理变成只填表？", a: "让每项声明连接到可测试控制和运行证据，并让投诉、事件或重大变化触发重新决定。", depth: "证据包要连接用途、候选人群、数据与模型版本、切片评估、安全测试、人工监督、审批、例外、申诉、事件和退役证明。抽样验证文档与生产实际一致，而不是只检查字段是否填写。", ask: "哪三项关键控制能从政策一路追到当前 ATS 工作流和实际运行结果？", tag: "治理落地", basis: "持续保证", evidence: [evidence("iso-iec-42001", "要求建立、实施、维护并持续改进管理体系。"), evidence("nist-ai-rmf", "将风险管理贯穿设计、开发、使用与评估。")] },
  ].map((item) => ({ ...item, addedAt: "2026-07-21" })),
  evidenceCards: [
