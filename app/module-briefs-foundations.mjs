...
export const llm = {
  ...
  qa: [
    ...
    },
    {
      ...
      ask: "追问客户：语料多大、多久变化、是否按用户授权、答案是否必须给出处，以及关键证据放在不同位置时结果是否稳定？",
      tag: "上下文",
      basis: "长上下文研究 + 知识治理边界",
      evidence: [
    ...
    },
    {
      ...
      ask: "追问客户：用户更敏感的是首字等待、生成过程、完整响应时间，还是单位达标结果成本？",
      tag: "性能成本",
...
export const fineTuning = {
  ...
  qa: [
    ...
    },
    {
      ...
      ask: "追问客户：谁能裁决理想答案？样本是否覆盖边界和拒答，训练集与评估集怎样避免重复和泄漏？",
      tag: "数据准备",
      basis: "监督微调实践 + 风险治理",
      evidence: [
    ...
    },
    {
      ...
      ask: "追问客户：哪些未见任务和业务硬指标必须提升？哪些通用或安全能力绝不能退化？",
      tag: "验收",
      basis: "持续评估 + 对齐研究边界",
      evidence: [
