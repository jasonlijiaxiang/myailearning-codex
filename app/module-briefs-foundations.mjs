...
export const llm = {
  ...
  deepDives: [
    ...
    },
    {
      ...
      sourceIds: ["transformer-2017", "lost-middle", "attention-not-explanation-2019", "nist-genai-profile"],
      columnLabels: {
        name: "变化来源",
        mechanism: "为什么会变化",
        decision: "验证与控制",
  ...
  relatedSlugs: ["model-landscape", "llm-training", "llm-inference", "prompt-engineering", "rag", "fine-tuning", "multimodal"],
  qa: [
    {
    ...
    },
    {
      ...
      evidence: [
        ...
        { sourceId: "attention-not-explanation-2019", supports: "支持在论文评估的标准注意力模型和任务中，不同注意力分布可产生等价预测，从而反驳把权重当作完整解释。" },
    ...
    },
    {
      ...
      basis: "长上下文研究 + 知识治理边界",
      evidence: [
        { sourceId: "lost-middle", supports: "在论文测试的多文档问答与键值检索中，相关信息位置显著影响表现；不支持外推为所有模型相同或 RAG 必然更好。" },
    ...
    },
    {
      ...
      evidence: [
        ...
        { sourceId: "vllm-2023", supports: "支持生产 LLM Serving 中区分 Prompt 处理与迭代解码；具体表现仍受引擎、模型、硬件与负载限制。" },
      ],
    },
  ],
  evidenceCards: [
  ...
  qa: [
    ...
    },
    {
      ...
      evidence: [
        ...
        { sourceId: "hf-trl-sft-trainer", supports: "支持分别配置训练与评估并观察监督微调过程。" },
      ],
    },
    {
