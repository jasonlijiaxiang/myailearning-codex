    ...
    <main lang="en" className="fieldbookTheme codingAgentPage">
      ...
      <section className="section codingAgentFreshness" aria-labelledby="freshness-title">
        <div className="sectionNumber">04</div><div className="sectionBody">
          ...
          <p className="paperBoundary"><strong>Current review priority:</strong> Google has announced a Gemini CLI to Antigravity CLI migration, so the relevant entry is marked watch. Read the <Link href="/en/references#source-product-antigravity-migration">official migration notice and its scope ↗</Link></p>
        </div>
      </section>
