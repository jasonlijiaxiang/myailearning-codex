...
export const promptQa = [
  ...
  {
    q: "LLM-as-a-Judge 能不能完全替代人工评审？",
    a: "不能。模型评分器适合扩大覆盖和持续回归，但必须用清晰 Rubric、人工金标和定期校准约束，尤其不能作为高风险任务的唯一门禁。",
    depth: "优先让评分器做分类、成对比较或针对具体标准判断，减少开放式总分。评估中应随机化候选顺序，监测位置、冗长、自偏好和风格偏差，并按场景切片计算与人工的一致性。出现模型、Prompt 或业务分布变化后要重新校准；事实正确性和真实业务终态尽量由权威数据或确定性检查验证。",
    ask: "追问客户：哪些评分可以自动化，哪些错误必须由领域专家确认？Judge 与人工标签的一致性是否持续监测？",
    tag: "评估方法",
    basis: "官方评估实践 + 人工校准",
    evidence: [
