...
const moduleSpecs = [
  ...
  ["ai-agent", "agent-title", ["ai-agent", "harness", "harness-engineering", "agent-engineering", "perceive", "reason", "act", "observe", "planning", "memory", "tools"], "dedicated", "2026-09-04", "2026-07-17"],
  ["multimodal", "multimodal-title", ["multimodal", "vision-transformer", "ocr", "asr", "document-intelligence"], "brief", "2026-08-31", "2026-07-17"],
  ["mcp", "mcp-title", ["mcp", "tool-discovery", "identity-authorization", "mcp-protocol-roles", "mcp-primitives"], "brief", "2026-09-04", "2026-07-17"],
  ["a2a", "a2a-title", ["a2a", "agent-card", "a2a-message", "a2a-task", "artifact", "agent-collaboration", "identity-authorization"], "brief", "2026-09-04", "2026-07-17"],
  ["veadk", "veadk-title", ["veadk", "google-adk", "agent-runner", "short-term-memory", "root-agent", "agentkit-app-adapter", "tool-loop"], "brief", "2026-08-31", "2026-08-15"],
  ["agentkit", "agentkit-title", ["agentkit", "agentkit-runtime", "agent-application", "runtime-binding", "deployment-mode", "build-deploy-lifecycle", "managed-agent-memory", "agentkit-app-adapter"], "brief", "2026-08-31", "2026-08-15"],
  ["evaluation", "evaluation-title", ["evaluation", "evaluation-contract", "golden-set", "observability", "evaluation-layers", "llm-as-judge"], "brief", "2026-08-31", "2026-07-17"],
  ...
  ["ai-ops", "ai-ops-title", ["ai-ops", "ai-application-engineering", "genaiops", "ai-release-manifest", "configuration-bundle", "release-evaluation", "shadow-traffic", "observability", "golden-set", "cost-allocation", "cost-anomaly"], "brief", "2026-08-31", "2026-07-17"],
  ...
  ["llm-training", "llm-training-title", ["llm-training", "distributed-training", "evaluation"], "brief", "2026-08-31", "2026-07-17"],
  ["llm-inference", "llm-inference-title", ["llm-inference", "kv-cache", "batching", "quantization", "ttft", "tpot", "goodput"], "brief", "2026-08-31", "2026-07-17"],
  ["data-engineering", "data-engineering-title", ["data-engineering", "document-intelligence", "dense-retrieval", "data-contract", "data-lineage", "deletion-propagation"], "brief", "2026-08-31", "2026-07-17"],
  ...
  ["ai-infra-compute", "ai-infra-compute-title", ["ai-infra-compute", "heterogeneous-compute", "vram", "hbm", "scale-up", "scale-out", "tco"], "brief", "2026-08-31", "2026-07-17"],
];
...
const moduleQaCoverageTags = Object.freeze({
  ...
  veadk: Object.freeze([
    "产品定位", "继承与版本", "执行与状态", "工具边界", "多实例状态", "状态分层", "应用适配",
  ]),
  agentkit: Object.freeze([
    "产品定位", "应用合同", "CLI 生命周期", "上线门禁", "状态与身份", "Memory 架构", "可观测与性能",
  ]),
